...
for neuron_type in neurons:
    ...
    network_name = "DVSGesure_"+neuron_type+"_"+str(input_size)+"_"+("_".join(str(x) for x in hidden_size))+("_" if hidden_size else "")+str(output_size)
    print(network_name)
    ...
    for _ in range(6):
        ...
        if use_existing_model:
            ...
            train_results = network.train_network(device, scnn_net, trainloader, num_epochs=75)
